...
void macro1(){
    ...
    // Draw the graph !
    graph.DrawClone("APE"); // DrawClone() required because the function is called in another
	// function and so it drawing would disappear and only clone stays there.
